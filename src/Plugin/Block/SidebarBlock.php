...
class SidebarBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    $build['#theme'] = 'oe_corporate_blocks_sidebar';

    $config = $this->configFactory->get('oe_corporate_blocks.data.sidebar');

    NestedArray::setValue($build, ['#corporate_sidebar', 'sidebar', 'title'], $config->get('sidebar_title'));
